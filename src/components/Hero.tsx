...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-secondary/30 via-background to-accent/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-24 md:py-32 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left space-y-6">
            ...
            {/* Description */}
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 animate-fade-up animation-delay-200">
              Helping businesses understand customers, revenue & inventory by turning data into decisions. Specialized in SQL, Excel, Power BI, Python, and AI Tools.
            </p>
            
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-up animation-delay-300 pt-2">
              <Button 
                className="group bg-foreground hover:bg-foreground/90 text-background rounded-full px-8 py-6 text-base font-semibold shadow-card hover:shadow-glow transition-all duration-300"
                asChild
              >
              ...
              <Button 
                variant="outline"
                className="border-2 border-foreground bg-transparent text-foreground hover:bg-foreground hover:text-background rounded-full px-8 py-6 text-base font-semibold transition-all duration-300"
                asChild
              >
            ...
            <div className="flex gap-4 justify-center lg:justify-start animate-fade-up animation-delay-400 pt-4">
              <a 
                ...
                className="p-3 rounded-full bg-secondary hover:bg-accent/10 text-muted-foreground hover:text-accent transition-all duration-300"
                aria-label="LinkedIn"
              >
              ...
              <a 
                href="mailto:srikar@example.com"
                className="p-3 rounded-full bg-secondary hover:bg-accent/10 text-muted-foreground hover:text-accent transition-all duration-300"
                aria-label="Email"
              >
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end items-center animate-fade-up animation-delay-200">
            <div className="relative max-w-md lg:max-w-lg">
              ...
              <div className="absolute inset-0 border-2 border-dashed border-accent/30 rounded-full scale-[1.15] animate-spin-slow" style={{ animationDuration: '25s' }} />
              ...
              <div className="absolute -right-4 sm:right-0 top-1/3 bg-background shadow-badge px-4 py-2 rounded-xl border border-border animate-float-slow z-20" style={{ animationDelay: '0.5s' }}>
                <span className="text-sm font-semibold text-foreground">Power BI</span>
              </div>
              
              {/* Floating Badge - AI Tools (Bottom Left) */}
              <div className="absolute -left-2 sm:left-4 bottom-1/4 bg-accent text-accent-foreground shadow-glow px-4 py-2 rounded-xl animate-float-delayed z-20" style={{ animationDelay: '1s' }}>
